...
},{"./controllers/AppController":3}],3:[function(require,module,exports){
'use strict';
...
var _Round = require('../models/Round');
...
var _CardList = require('../models/CardList');

var _CardList2 = _interopRequireDefault(_CardList);

var _CardsPlayerView = require('../view/CardsPlayerView');

var _CardsPlayerView2 = _interopRequireDefault(_CardsPlayerView);

var _CardsBotView = require('../view/CardsBotView');

var _CardsBotView2 = _interopRequireDefault(_CardsBotView);
...
var AppController = function () {
    function AppController() {
        ...
        this._round = new _Round2.default();
        this._playerView = new _CardsPlayerView2.default('#playerCards');
        this._botView = new _CardsBotView2.default('#botCards');
    ...
    _createClass(AppController, [{
        ...
        value: function _generateCards() {
            ...
            var cardList = new _CardList2.default();

            for (var i = 0; i < 5; i++) {

                var _number = Math.floor(Math.random() * (10 - 1 + 1) + 1);
                var _id = Math.floor(Math.random() * (999 - 1 + 1) + 1);
...
},{"../models/Card":4,"../models/CardList":5,"../models/Player":6,"../models/Round":7,"../view/CardsBotView":8,"../view/CardsPlayerView":9,"jquery":1}],4:[function(require,module,exports){
"use strict";
...
var CardList = function () {
    ...
    _createClass(CardList, [{
        ...
        value: function removeById(id) {
            ...
            this._list.forEach(function (card, index) {

                if (card.id === id) _this._list.splice(index, 1);
            });
        }
    }, {
        key: "list",
...
var Player = function () {
    ...
    _createClass(Player, [{
        key: "getCardsById",
        value: function getCardsById(id) {

            var result = null;

            this._cards.list.forEach(function (card) {
        ...
        get: function get() {
            ...
            var cardsCount = this._cards.list.length;
            var selectionRandom = Math.floor(Math.random() * (cardsCount - 0 + 0) + 0);
...
var Round = function () {
  ...
  _createClass(Round, [{
    ...
    get: function get() {
      ...
      var playerValue = this._playerSelection.value;
      var botValue = this._botSelection.value;
...
var CardsBotView = function () {
  function CardsBotView(elem) {
    _classCallCheck(this, CardsBotView);

    this._elem = (0, _jquery2.default)(elem);
  }

  _createClass(CardsBotView, [{
    key: 'update',
    ...
    value: function selectCard(card) {
      ...
      this._elem.find('.card').each(function (index, elem) {

        var _elem = (0, _jquery2.default)(elem);
        var _id = _elem.data('id');
...
var CardsPlayerView = function () {
  function CardsPlayerView(elem) {
    _classCallCheck(this, CardsPlayerView);

    this._elem = (0, _jquery2.default)(elem);
  }

  _createClass(CardsPlayerView, [{
    key: 'update',
    value: function update(model) {
  ...
  return CardsPlayerView;
}();

exports.default = CardsPlayerView;
